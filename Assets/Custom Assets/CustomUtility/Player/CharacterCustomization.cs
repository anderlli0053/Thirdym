...
public class CharacterCustomization : MonoBehaviour
{
    ...
    {
        PlaySFX(Gann4Methods.G4Audio.GetRandomClip(preset.enemyDownSFX));
    }
    public void PlayAlertSFX()
    {
        PlaySFX(Gann4Methods.G4Audio.GetRandomClip(preset.alertSFX));
    }
    public void PlayPainSFX()
    {
        PlaySFX(Gann4Methods.G4Audio.GetRandomClip(preset.painSFX));
    }
    public void PlayInjurySFX()
    {
        PlaySFX(Gann4Methods.G4Audio.GetRandomClip(preset.injuryStateSFX));
    }
    public void PlayDeathSFX()
    {
        PlaySFX(preset.forcedDeathSFX);
        PlaySFX(Gann4Methods.G4Audio.GetRandomClip(preset.deathSFX));
    }
    #endregion
}
